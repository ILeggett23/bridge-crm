...
function roleStageChecks(role,contact=null) { return PIPELINES[role].map(stage=>stageCheck(stage,stageTitle(stage)===stageLabel(stage)?"":stageTitle(stage),{type:"radio",checked:Boolean(contact?.stages?.[stage])})).join(""); }
