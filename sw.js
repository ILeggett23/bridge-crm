const CACHE = "bridge-app-v62";
const ROOT = new URL("./", self.location.href).href;
importScripts(new URL("config.js?v=62", ROOT).href);
...
self.addEventListener("push", event => {
  ...
  const options = {
    ...
    icon: new URL("bridge-icon-192.png?v=62", ROOT).href,
    badge: new URL("bridge-icon-192.png?v=62", ROOT).href,
