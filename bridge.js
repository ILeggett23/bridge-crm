...
function stageLabel(stage) { return ({ PQI:"Pre-Qualifying", "QI/P":"Quality Interview", FUP:"Follow-Up", LA:"Launch", CNA:"Needs Assessment", Recommendation:"Recommendation", "Decision / Follow-Up":"Decision & Follow-Up", "Order Placed":"Order Placed", "Active Customer":"Active", "Reorder / Retention":"Reorder & Retention" })[stage] || stage; }
...
function roleStageChecks(role,contact=null) { const type=role==="Customer"?"radio":"checkbox"; return PIPELINES[role].map(stage=>stageCheck(stage,"",{type,checked:Boolean(contact?.stages?.[stage])})).join(""); }
